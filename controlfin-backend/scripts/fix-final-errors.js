...
function fixFile(filePath) {
    try {
        ...
        // Add missing imports for transaction routes
        if (filePath.includes('transaction.routes.ts')) {
  ...
  isUpdateTransactionRequest
            ...
            content = content.slice(0, nextLineIndex + 1) + typeImport + content.slice(nextLineIndex + 1);
        }
